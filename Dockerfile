...
ENV DATABASE_CONNECTION_HOST='mongo-server'
ENV DATABASE_CONNECTION_PORT='11229'
ENV DATABASE_CONNECTION_USER='root'
ENV DATABASE_CONNECTION_PASSWORD='M2Sp0gFD3wrT04zsK'
